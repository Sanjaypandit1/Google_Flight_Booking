...
const TripScreen = () => {
  ...
  const fetchPopularTrips = async () => {
    try {
      ...
      const convertedTrips: Trip[] = popularTrips.map(({ popularity, ...trip }) => trip)
    ...
    if (!requireAuth()) {
      Alert.alert("Sign In Required", "You must be signed in to book flights. Would you like to sign in now?", [
        { text: "Cancel", style: "cancel" },
        {
          text: "Sign In",
          onPress: () => {
            // In a real app, you might navigate to auth screen or show auth modal
    ...
    <View style={styles.tripCard}>
      ...
      <View style={styles.routeContainer}>
        ...
        <View style={styles.durationSection}>
          ...
          <Text style={styles.durationText}>{item.returnDate ? "Round Trip" : "One Way"}</Text>
        </View>

        <View style={styles.routeSection}>
          <Text style={styles.routeTime}>{item.returnDate ? item.returnDate : "One way"}</Text>
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Loading the most popular destinations...</Text>
        </View>
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.emptyState}>
          ...
          <TouchableOpacity style={styles.searchFlightsButton} onPress={fetchPopularTrips}>
    ...
    <View style={styles.container}>
      ...
      {filteredTrips.length === 0 ? (
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyStateSubtext}>Popular trips will appear here once data is available</Text>
